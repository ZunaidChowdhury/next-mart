...
export default function AddProductPage() {
  ...
  // Loading screen while auth check is in progress
  if (checkingAuth) {
    return (
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 w-full flex-1 bg-background">
      ...
      >
        {/* ─── LEFT COLUMN: Details + Media + Features ─── */}
        ...
        {/* ─── RIGHT COLUMN: Pricing + Taxonomy + Visibility + Actions ─── */}
