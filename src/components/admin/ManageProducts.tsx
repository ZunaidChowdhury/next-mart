    ...
    <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 w-full flex-1 bg-background">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center justify-center gap-2">
                        <Button
                          ...
                          title={product.isPrivate ? "Make Live" : "Make Private"}
                        >
      ...
      >
        <Modal.Backdrop className="bg-black/40 backdrop-blur-md">
          <Modal.Container placement="center" className="bg-card-bg/95 border border-border-accent shadow-2xl rounded-2xl overflow-hidden backdrop-blur-lg">
            <Modal.Dialog>
      ...
      >
        <Modal.Backdrop className="bg-black/40 backdrop-blur-md">
          <Modal.Container placement="center" scroll="inside" className="bg-card-bg/95 border border-border-accent shadow-2xl rounded-2xl backdrop-blur-lg">
            <Modal.Dialog>
              <Modal.CloseTrigger className="text-foreground/40 hover:text-foreground transition-colors top-4 right-4" />
